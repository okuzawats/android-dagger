package com.okuzawats.dagger.ui.home
...
class HomeSecondFragment : Fragment() {
  ...
  override fun onViewCreated(
    ...
    view.findViewById<TextView>(R.id.textview_home_second)
        .text =
      getString(R.string.hello_home_second, args.myArg)

    view.findViewById<Button>(R.id.button_home_second)
        .setOnClickListener {
